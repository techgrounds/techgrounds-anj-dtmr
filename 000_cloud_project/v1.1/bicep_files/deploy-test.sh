...
# az provider register --namespace Microsoft.Network --subscription <subscription-id> --location uksouth
# az provider register --namespace Microsoft.Network --subscription 'Cloud Student 1' --location uksouth
