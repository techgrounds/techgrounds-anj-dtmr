...
// Test-NetConnection -ComputerName hs3i7xy3giol2.database.windows.net -Port 1433
...
resource virtualNetworkLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
  name: '${privateDnsZoneManagement.name}-virtualNetworkLinks-${vnetManagement.name}'
...
// resource virtualNetworkLinkWebApp 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2021-09-01' = {
//   name: '${privateDnsZone.name}/virtualNetworkLinks/${vnetWebApp.name}'
//   properties: {
//     registrationEnabled: true
//     virtualNetwork: {
//       id: vnetWebApp.id
