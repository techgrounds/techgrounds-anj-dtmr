...
- If you want to download the repository's [v1.0](https://github.com/techgrounds/techgrounds-anj-dtmr/releases/tag/v1.0) release. Click the 'v1.0' under the 'Releases' below the About, and then select which file you want to download.
