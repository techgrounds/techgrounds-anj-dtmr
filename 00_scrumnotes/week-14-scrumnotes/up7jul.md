...
- Jenny: script gevonden over vmss en gateway
- Roan: documentati bijna af
- Akram:
- Jon: application gateway, vmss deployed, een ding tegelijk
- Sjoerd: bezig met vmss en gateway
- Rogier: web server error met peering
