...
- Jenny: vmss, 11u met Casper
- Roan: recovery service vault, db voor management server maar moet met vmss, documentatie
- Akram: deze week documentatie
- Jon: testen en documentatie
- Sjoerd: vmss testen, db en recovery niet meer, certificate focussen
- Rogier: blij met presentatie, private endpoints db to storage account, certificate, db backup
