...
- Jenny: twee vm machines, public ip coupelen
- Roan: key vault, disk encryption niet gelukt, db en recovery vault
- Akram: overal bezig maar niets gedaan, proberen vandaag iets
- Jon: energie 2.5, voortgang voor peering, nic pubip nsg als het lukt verder met key vault
- Sjoerd: key vault errors, seeting van db
- Rogier: DB to management server gelink. energie 2.5
