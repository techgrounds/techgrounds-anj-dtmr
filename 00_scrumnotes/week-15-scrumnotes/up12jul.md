...
- Jenny: app gateway and vmss troubleshooten, key vault met sjoerd
- Roan: db
- Akram: beginnen met db
- Jon: slecht geslapen, db dan gateway
- Sjoerd: gateway troubleshooten dan key vault
- Rogier: db private endpoint
