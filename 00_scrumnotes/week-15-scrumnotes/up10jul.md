...
- Jenny: documentatie schrijven
- Roan: door knallen, http certificaat rerouting
- Akram: verder met troubleshooten
- Jon: application gateway, error met peering
- Sjoerd: scaleset and gateway, certificaat vanuit keyvault
- Rogier: storage account, backup systeem, tsl and gateway
