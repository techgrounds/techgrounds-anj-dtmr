...
- Jenny:
- Roan: connected storage, scale set beginnen
- Akram:
- Jon: blij dat webserver nu staat en kan verder bouwen
- Sjoerd: vm gelanceerd maar errors
- Rogier: portal voor security group, apache installeren,
