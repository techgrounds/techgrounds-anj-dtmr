...
- Jenny:
- Roan: vmss deployed, database beginnen
- Akram: web & admin server deployed, key vault beginnen
- Jon: gisteren verschillende resources bezig, vnet2 verder
- Sjoerd: key vault
- Rogier: bijna klaar in module te zetten, probleem met outputs, kijk nog op windows server, key vault beginnen
